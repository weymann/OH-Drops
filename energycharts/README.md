...
AI calculated pricing forecast is optional and needs registration at [Energy Forecast Provider](https://www.energyforecast.de/).
 
## Binding Configuration

### `energy-data` Thing Configuration
...
Access to AI calculated pricing forecast requires [Registration](https://www.energyforecast.de/users/sign_up).
It doesn't serve all bidding zones.
...
| origin        | Number                | Show the origin of the price (market or forecast) |

`forecast` delivers timeseries of prices for the future.
Based on your config it delivers more or less entries:

- 

`origin` is showing the source of the price.

- 0: Market Day-Ahead
- 1: AI Forecast Calculation
